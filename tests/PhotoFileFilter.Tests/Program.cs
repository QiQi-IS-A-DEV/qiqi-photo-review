...
using PhotoFileFilter.Features.Onboarding.Views;
...
using PhotoFileFilter.Features.Review.Views;
...
internal static class Program
{
    ...
    private static int Main()
    {
        ...
        app.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("/PhotoFileFilter;component/Shared/Resources/Styles.xaml", UriKind.Relative) });
