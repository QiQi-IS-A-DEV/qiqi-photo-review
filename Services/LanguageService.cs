...
public static class LanguageService
{
    ...
    private static readonly Dictionary<string, string> Vi = new(StringComparer.Ordinal)
    {
        ...
        ["IMPORT & REVIEW"]="NHẬP & REVIEW ẢNH", ["Library"]="Thư viện", ["  |  Review workspace"]="  |  Không gian review", ["Dark theme"]="Giao diện tối",
        ...
        ["Photo Filter:"]="Lọc ảnh:", ["Rating & Flags"]="Rating & Đánh dấu", ["Color Label"]="Nhãn màu", ["P Pick"]="P  Chọn", ["X Reject"]="X  Loại", ["U Clear"]="U  Bỏ cờ",
