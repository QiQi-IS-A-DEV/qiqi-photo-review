...
public static class LanguageService
{
    ...
    private static readonly Dictionary<string, string> Vi = new(StringComparer.Ordinal)
    {
        ...
        ["4. Scan and check the results. "]="4. Quét và kiểm tra kết quả. ", ["Select Scan Photos or press F5. Review Files Found, Not Found, and Notes / Errors. Clear the COPY check box for any file you do not want to copy. Select a result and press Space or double-click to open Quick Preview; use Left/Right to browse, the wheel to zoom, drag to pan, R to rotate the view, and Esc to close."]="Bấm Quét ảnh hoặc F5. Kiểm tra File tìm thấy, Không tìm thấy và Ghi chú / Lỗi. Bỏ chọn CHÉP với file không muốn sao chép. Chọn một kết quả rồi nhấn Space hoặc nhấp đúp để mở Xem nhanh; dùng Trái/Phải để đổi ảnh, con lăn để zoom, kéo để di chuyển, R để xoay góc xem và Esc để đóng.",
        ...
        , ["Rating · red/yellow/green/blue/purple label · clear color"]="Chấm sao · nhãn đỏ/vàng/xanh lá/xanh dương/tím · xóa màu"
        , ["Pick · Reject · remove flag"]="Pick · Reject · bỏ cờ", ["Undo the most recent review action"]="Hoàn tác thao tác Review gần nhất"
        , ["Grid · Loupe · toggle Grid/Loupe"]="Grid · Loupe · chuyển đổi Grid/Loupe", ["Show or hide the Filmstrip"]="Ẩn hoặc hiện Filmstrip"
